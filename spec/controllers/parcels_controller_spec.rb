...
RSpec.describe ParcelsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all parcels as @parcels" do
      ...
      expect(assigns(:parcels)).to eq([parcel])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested parcel as @parcel" do
      parcel = Parcel.create! valid_attributes
      get :show, params: {id: parcel.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested parcel as @parcel" do
      parcel = Parcel.create! valid_attributes
      get :edit, params: {id: parcel.to_param}, session: valid_session
      expect(assigns(:parcel)).to eq(parcel)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Parcel" do
        expect {
          post :create, params: {parcel: valid_attributes}, session: valid_session
        }.to change(Parcel, :count).by(1)
      end

      it "assigns a newly created parcel as @parcel" do
        post :create, params: {parcel: valid_attributes}, session: valid_session
        expect(assigns(:parcel)).to be_a(Parcel)
        expect(assigns(:parcel)).to be_persisted
      end

      it "redirects to the created parcel" do
        post :create, params: {parcel: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Parcel.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved parcel as @parcel" do
        post :create, params: {parcel: invalid_attributes}, session: valid_session
        expect(assigns(:parcel)).to be_a_new(Parcel)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested parcel" do
        parcel = Parcel.create! valid_attributes
        put :update, params: {id: parcel.to_param, parcel: new_attributes}, session: valid_session
        parcel.reload
      ...
      it "assigns the requested parcel as @parcel" do
        parcel = Parcel.create! valid_attributes
        put :update, params: {id: parcel.to_param, parcel: valid_attributes}, session: valid_session
        expect(assigns(:parcel)).to eq(parcel)
      end
      ...
      it "redirects to the parcel" do
        parcel = Parcel.create! valid_attributes
        put :update, params: {id: parcel.to_param, parcel: valid_attributes}, session: valid_session
        expect(response).to redirect_to(parcel)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the parcel as @parcel" do
        parcel = Parcel.create! valid_attributes
        put :update, params: {id: parcel.to_param, parcel: invalid_attributes}, session: valid_session
        expect(assigns(:parcel)).to eq(parcel)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested parcel" do
      parcel = Parcel.create! valid_attributes
      expect {
        delete :destroy, params: {id: parcel.to_param}, session: valid_session
      }.to change(Parcel, :count).by(-1)
    end
