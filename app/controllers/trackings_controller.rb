class TrackingsController < ApplicationController
  ...
  private
    ...
    def tracking_params
      params.require(:tracking).permit(:parcel_id, :signed_for_by, :tracking_code, :tracking_status, :tracking_status_description, :required_to_arrive_before, :will_arrive_in_time)
    end
end
